...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://drive.google.com/uc?id=1vpPD7-2oW-hznGcwGy9zAhgdmb0NvmLf", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open_url("https://drive.google.com/uc?id=193h4RpWqae7lkqbBfI8Oc4lm6_gHwsBI", cache_dir=cache_dir, verbose=verbose) as f:
